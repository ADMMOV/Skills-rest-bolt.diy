          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="e.g., Jane Doe" required className="pl-10" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="e.g., you@example.com" required className="pl-10" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="phone" type="tel" placeholder="e.g., (123) 456-7890" required className="pl-10" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="city" placeholder="e.g., New York, NY" required className="pl-10" />
              </div>
            </div>
            {/* In a real app, Job Types and Availability would be multi-select components */}
            <div className="space-y-2">
              <Label>Preferred Job Types</Label>
              <Input placeholder="Bartender, Server, Kitchen Hand" />
            </div>
            <div className="space-y-2">
              <Label>General Availability</Label>
              <Input placeholder="Weekends, Evenings" />
            </div>
          </div>
